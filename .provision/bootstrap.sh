...
echo "|                 \"127.0.0.5/\" in a browser.            |"
echo "|                                                         |"
echo "|  If you haven't already, I would suggest editing your   |"
echo "|     hosts file with \"127.0.0.5  easyengine.dev\"       |"
echo "|         so that you can view your server with           |"
echo "|      \"easyengine.dev/\" instead of \"127.0.0.5/\"      |"
echo "|                      in a browser.                      |"
echo "|                                                         |"
echo "|  You can SSH into 127.0.0.5:1022 with ubuntu / vagrant  |"
echo "|                                                         |"
echo "+---------------------------------------------------------+"
